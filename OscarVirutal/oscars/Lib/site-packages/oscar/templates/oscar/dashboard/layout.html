...
{% block layout %}
    ...
    {% block dashboard_nav %}
        ...
        <nav class="navbar navbar-static-top navbar-inverse navbar-primary test">
...
{% block extrascripts %}
    ...
    {# jQuery plugins #}
    <script src="{% static "oscar/js/mousewheel/jquery.mousewheel.min.js" %}"></script>
    <script src="{% static "oscar/js/bootstrap-datetimepicker/bootstrap-datetimepicker.js" %}"></script>
    <script src="{% static "oscar/js/bootstrap-datetimepicker/locales/bootstrap-datetimepicker.all.js" %}"></script>
    <script src="{% static "oscar/js/inputmask/jquery.inputmask.bundle.min.js" %}"></script>
    <script src="{% static "oscar/js/select2/select2.js" %}"></script>
